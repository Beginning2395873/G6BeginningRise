                ...
                <div class="card-body mt-2">
                    <form action="../controller/productoControlador.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input class="form-control form-control-sm" type="file" id="imagen" accept=".jpg, .png, .webp" name="imagen">
                        </div>

                        <!-- Enviar -->
                        <div class="col mx-auto" style="max-width: 130px;"></div>
