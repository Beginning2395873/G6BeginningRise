...
$query = "SELECT count(*) as totalRegistros from administradores";
...
if (!empty($_POST['search'])) {
    ...
    $sqlcuentaBusqueda = "SELECT count(persona.tipo_documento_persona) as totalBusqueda, persona.num_doc_persona, persona.nombre_persona, administradores.email_administrador, persona.foto_perfil, persona.estado FROM persona INNER JOIN administradores ON persona.email_persona = administradores.email_administrador where tipo_documento_persona like '%$obj->busqueda%' or num_doc_persona like '%$obj->busqueda%' or nombre_persona like '%$obj->busqueda%' and persona.estado != 0";
    ...
    $query2 = "SELECT persona.tipo_documento_persona, persona.num_doc_persona, persona.nombre_persona, administradores.email_administrador, persona.foto_perfil, persona.estado FROM persona INNER JOIN administradores ON persona.email_persona = administradores.email_administrador where tipo_documento_persona like '%$obj->busqueda%' or num_doc_persona like '%$obj->busqueda%' or nombre_persona like '%$obj->busqueda%' and estado != 0 limit $desde,$maximoRegistros";
    $resultado2 = mysqli_query($c, $query2);
    $arreglo2 = mysqli_fetch_array($resultado2);
} else {
    $query2 = "SELECT persona.tipo_documento_persona, persona.num_doc_persona, persona.nombre_persona, administradores.email_administrador, persona.foto_perfil, persona.estado FROM persona INNER JOIN administradores ON persona.email_persona = administradores.email_administrador WHERE estado != 0 limit $desde,$maximoRegistros";
    $resultado2 = mysqli_query($c, $query2);
    $arreglo2 = mysqli_fetch_array($resultado2);
}
?>
        ...
        <div class="row">
            <div class="col-6">
                <div class="input-group d-flex" style="max-width: 400px;">
                    <!-- Búsqueda -->
                    <form action="adminlist.php" class="d-flex" role="search" method="POST">
                    ...
                    <a href="adminlist.php" class="btn btn-outline-warning ms-2">
                                ...
                                ?>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><img src="<?php echo $arreglo2[4] ?>" alt="" width="80px"></td>
                                            <td><?php echo $status ?></td>
                                            <td><?php echo "<a href='editar_admin.php?email_admin=" . $arreglo2[3] . "''><button type='button' class='btn btn-primary'><i class='fa-solid fa-pen-to-square'></i></button></a>" ?></td>
                                            <td><?php echo "<form action='../controller/adminControlador.php' method='POST'>
                                                <input type='hidden' name='correo_admin' value='$arreglo2[3]' />
