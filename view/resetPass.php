                ...
                <div class="card-body mt-2">
                    <div class="row">
                        <div class="col mx-auto" style="max-width: 250px;">
                            <form action="?page=passrecover&opcion=passReset" method="POST">
                                <!-- Email input -->
                                <div class="grupo">
                                    <input type="hidden" name="ingresar" value="">
                                    <input class="login" name="codigo" type="text" id="correo" required />
                                ...
                                <div class="grupo">
                                    <input class="login" name="pass2" type="password" id="pass" required />
                                    <span class="highlight"></span>
                                    <span class="bar"></span>
                                    <label class="etiqueta" for="pass2">Confirmar Contraseña</label>
                                </div>
                                <!-- Submit button -->
                                <div class="row d-flex justify-content-evenly mt-3">
                                    <div class="col mx-auto" style="max-width: 210px" >
                                        ...
                                        <a href="?page=passrecover" class="btn btn-outline-light btn-block me-2">Regresar</a>
                                    </div>
                                </div>
                            </form>
                        </div>
