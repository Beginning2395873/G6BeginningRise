...
$query = "SELECT count(*) as totalRegistros from tiendas";
...
if (!empty($_POST['search'])) {
    ...
    $sqlcuentaBusqueda = "SELECT count(tiendas.nit_tienda) as totalBusqueda, tiendas.nombre_tienda, tiendas.direccion_tienda, tiendas.telefono_tienda, tiendas.email_tienda, tiendas.foto_tienda, tiendas.estado FROM tiendas where nit_tienda like '%$obj->busqueda%' or nombre_tienda like '%$obj->busqueda%' and tiendas.estado != 0";
    ...
    $query2 = "SELECT tiendas.nit_tienda, tiendas.nombre_tienda, tiendas.direccion_tienda, tiendas.telefono_tienda, tiendas.email_tienda, tiendas.foto_tienda, tiendas.estado FROM tiendas where nit_tienda like '%$obj->busqueda%' or nombre_tienda like '%$obj->busqueda%' and tiendas.estado != 0 limit $desde,$maximoRegistros";
    $resultado2 = mysqli_query($c, $query2);
    $arreglo2 = mysqli_fetch_array($resultado2);
} else {
    $query2 = "SELECT tiendas.nit_tienda, tiendas.nombre_tienda, tiendas.direccion_tienda, tiendas.telefono_tienda, tiendas.email_tienda, tiendas.foto_tienda, tiendas.estado FROM tiendas where tiendas.estado != 0 limit $desde,$maximoRegistros";
    $resultado2 = mysqli_query($c, $query2);
    $arreglo2 = mysqli_fetch_array($resultado2);
}
?>
                ...
                <div class="col-2 px-2">
                    ...
                    <div class="collapse navbar-collapse align-self-end" id="navbarTogglerDemo02">
                        ...
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            <li class="nav-item">
                                <a class="btn text-light btn-lg btn-outline-link px-2 me-2" href="../indexphp">
        ...
        <div class="row">
            <div class="col-6">
                <div class="input-group d-flex" style="max-width: 400px;">
                    <!-- Búsqueda -->
                    <form action="storelist.php" class="d-flex" role="search" method="POST">
                    ...
                    <a href="storelist.php" class="btn btn-outline-warning ms-2">
                                ...
                                ?>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><img src="<?php echo $arreglo2[5] ?>" alt="" width="80px"></td>
                                            <td><?php echo $status ?></td>
                                            <td><?php echo "<form action='../controller/tiendasControlador.php' method='POST'>
                                                <input type='hidden' name='nit' value='$arreglo2[0]' />
