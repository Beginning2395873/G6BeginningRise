        ...
        <div class="col-md-4 border-end">
            <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                ...
                <span class="fw-bold fs-3">
                    ¡Bienvenido <?php echo $arreglo['nombre_tienda']; ?>!
                </span>
        ...
        <div class="col-md-4">
            <div class="p-3 py-5 mt-4">
                <div class="d-grid gap-3">
                    ...
                    <a href="<?php echo urlsite ?>?page=tienda&opcion=añadirBanner" class="btn btn-success btn-lg">
                        <i class="fa-solid fa-image me-2"></i>
                        Añadir Banner Promocional
                    </a>
                    <a href="<?php echo urlsite ?>?page=tienda&opcion=informeVentas" class="btn btn-success btn-lg">
