            ...
            <div class="accordion mt-5" id="accordionFlushExample">
                    ...
                    <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                        <?php foreach ($resultadoF as $tienda) { ?>
                            <div class="accordion-body">
                                <form class="filtro" action="?page=cliente&opcion=buscar" method="POST">
                ...
                <div class="accordion-item">
                    ...
                    <div id="flush-collapsenine" class="accordion-collapse collapse" aria-labelledby="flush-headingnine" data-bs-parent="#accordionFlushExample">
                        <div class="accordion-body">
                            <a class="text-decoration-none text-dark" href="?page=cliente&opcion=buscar&comp=precioasc">
                                Ascendente
                            </a>
                        </div>
                        <div class="accordion-body">
                            <a class="text-decoration-none text-dark" href="?page=cliente&opcion=buscar&comp=preciodesc">
                                Descendente
                            </a>
                        </div>
                    </div>
        ...
        <div class="col">
                                ...
                                <div class="card shadow-sm" style="width: 18rem;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="estrellas">
                                            ...
                                            for ($e = 1; $e <= 5; $e++) {
                                                ...
                                                echo '<span class="' . $clase_css_estrella . '" onclick="ratestar(' . $arreglo2['id_producto'] . ',' . $arreglo2['nit_tienda'] . ',' . $e . ')">
                                    ...
                                    <div class="card-footer d-flex">
                                        <div class="col-6 me-3">
                                            <a href='?page=cliente&opcion=addCart&email=<?php echo $user ?>&idProducto=<?php echo $arreglo2['id_producto'] ?>&nitTienda=<?php echo $arreglo2['nit_tienda'] ?>' class='btn btn-success addCart' onClick='alertaAddCart()'>
            ...
            <nav class="mt-5" aria-label="paginador">
                <ul class="pagination justify-content-center">
                    ...
                    ?>
                            <li class="page-item">
                                <a class="page-link" href="<?php echo urlsite ?>?page=cliente&opcion=buscar&comp=<?php echo $comp ?>&pagina=<?php echo 1; ?>">
                                    <i class="fa-solid fa-backward-fast my-1"></i>
                                </a>
                            </li>
                            <li class="page-item">
                                <a class="page-link" href="?page=cliente&opcion=buscar&comp=<?php echo $comp ?>&pagina=<?php echo $pagina - 1; ?>">
                                <i class="fa-solid fa-backward-step my-1"></i>
                                </a>
                            </li>
                        <?php } else { ?>
                            <li class="page-item ">
                                <a class="page-link" href="?page=cliente&opcion=buscar&pagina=<?php echo 1 ?>">
                                    <i class="fa-solid fa-backward-step my-1"></i>
                                </a>
                            </li>
                            <li class="page-item">
                                <a class="page-link" href="?page=cliente&opcion=buscar&pagina=<?php echo $pagina - 1 ?>">
                                    <i class="fa-solid fa-backward-step my-1"></i>
                                </a>
                            </li>
                        <?php
                            ...
                            if (isset($_GET['comp'])) {
                                ...
                                echo '
                                        <li class="page-item active" aria-current="page">
                                            <a class="page-link" href="?page=cliente&opcion=buscar&comp=' . $comp . '&pagina=' . $i . '">
                                                ' . $i . '
                                            </a>
                                        </li>';
                            } else {
                                echo '
                                        <li class="page-item active" aria-current="page">
                                            <a class="page-link" href="?page=cliente&opcion=buscar&pagina=' . $i . '">
                                                ' . $i . '
                                            </a>
                                        </li>';
                            }
                    ...
                    if ($pagina != $totalPaginas) {
                        ...
                        ?>
                            <li class="page-item">
                                <a class="page-link" href="<?php echo urlsite ?>?page=cliente&opcion=buscar&comp=<?php echo $comp ?>&pagina=<?php echo $pagina + 1; ?>">
                                    <i class="fa-solid fa-forward-step my-1"></i>
                                </a>
                            </li>
                            <li class="page-item">
                                <a class="page-link" href="?page=cliente&opcion=buscar&comp=<?php echo $comp ?>&pagina=<?php echo $totalPaginas; ?>">
                                    <i class="fa-solid fa-forward-fast my-1"></i>
                                </a>
                            </li>
                        <?php } else { ?>
                            <li class="page-item">
                                <a class="page-link" href="<?php echo urlsite ?>?page=cliente&opcion=buscar&pagina=<?php echo $pagina + 1; ?>">
                                    <i class="fa-solid fa-forward-step my-1"></i>
                                </a>
                            </li>
                            <li class="page-item">
                                <a class="page-link" href="?page=cliente&opcion=buscar&pagina=<?php echo $totalPaginas; ?>">
                                    <i class="fa-solid fa-forward-fast my-1"></i>
                                </a>
                            </li>
                    <?php
